            ...
            <div class="flex">
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <img
						...
						alt="Workflow" /> -->
                    <a href="/" class="text-md">Cumulus Creative</a>
                </div>
            </div>
            <div class="flex hidden sm:flex sm:space-x-8">
                <a
                    href="websites"
                    class:border-primary={segment === 'websites'}
                    class="border-transparent text-gray-500 hover:border-secondary hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                    Websites
                </a>
                <a
                    href="web-apps"
                    class:border-primary={segment === 'web-apps'}
                    class="border-transparent text-gray-500 hover:border-secondary hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                    Web Apps
                </a>
                <a
                    href="mobile-apps"
                    class:border-primary={segment === 'mobile-apps'}
                    class="border-transparent text-gray-500 hover:border-secondary hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                    Mobile Apps
                </a>
                <a
                    href="automation"
                    class:border-primary={segment === 'automation'}
                    class="border-transparent text-gray-500 hover:border-secondary hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                    Automation
                </a>
            </div>
