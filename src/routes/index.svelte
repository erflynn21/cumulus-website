...
<section name="hero">
    <div class="relative overflow-hidden mb-6">
        ...
        <main
            class="mt-16 mx-auto max-w-screen-2xl px-4 sm:mt-24 pb-10 relative"
        >
            <div class="text-center">
                <h1
                    class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl"
                >
                    <span class="xl:inline">We build powerful</span>
                    <span class="text-primary xl:inline">web</span>
                    <span class="xl:inline">and</span>
                    <span class="text-primary xl:inline">cloud</span>
                    <span class="xl:inline">solutions</span>
                </h1>
                <p
                    class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"
                >
                    Cumulus Creative Services uses a variety of tools and
                    techniques to bring powerful solutions to your business.
                    Whether it's a website or a fully automated workflow for you
                    and your employees, we've got you covered.
                </p>
                <div
                ...
                >
                    <div class="rounded-md shadow">
                        <a
                            href="contact"
                            class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-seconadry md:py-4 md:text-lg md:px-10">
                            Get in Touch
                        </a>
                    </div>
                </div>
    ...
    <div class="py-12 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center md:text-left">
                ...
                >The Face of Your Business</p>
                <p class="mt-4 text-xl text-gray-500 md:max-w-lg">
                    Your website should be modern, performant and informative.
                    Our websites are designed around you and your needs.
                </p>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center md:text-right">
                ...
                <p
                    class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"
                >The Logic of Your Business</p>
                <p
                    class="mt-4 text-xl text-gray-500 md:max-w-lg md:inline-block "
                >
                    Web application design and development to fit your business
                ...
                >
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            <dt
                                class="text-lg leading-6 font-medium text-gray-900"
                            >Secure Authentication</dt>
                            <dd class="mt-2 text-base text-gray-500">
                                Rest assured that data is locked securely behind
                                robust authentication methods, with a variety of
                                login methods available as well.
                            </dd>
                        </div>
                    </div>
    ...
    <div class="py-12 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center md:text-left">
                ...
                <p
                    class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"
                >Your Business in the App Store</p>
                <p class="mt-4 text-xl text-gray-500 md:max-w-lg">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center md:text-right">
                ...
                <p
                    class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"
                >The Tech of Your Business</p>
                <p
                    class="mt-4 text-xl text-gray-500 md:max-w-lg md:inline-block "
                >
                    Analyzing the technical requirements of your business and
                    providing the optimal solutions to fit your needs.
                </p>
            </div>
    ...
    <div class="py-12 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center md:text-left">
                ...
                <p
                    class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"
                >Automate Your Business Processes</p>
                <p class="mt-4 text-xl text-gray-500 md:max-w-lg">
                    Automation workflows that remove tedious tasks, saving you
                    and your employees time and money.
                </p>
            </div>
        ...
        <div class="max-w-7xl mx-auto py-12 px-4">
            ...
            >
                ...
                <img
                    ...
                    width="150px"
                    class="h-12 w-auto object-contain opacity-50 transition duration-250 ease-in-out transform hover:scale-110 hover:opacity-100"
                    src="https://res.cloudinary.com/cumulus-creative-services/image/upload/h_75/v1609136062/Cumulus%20Website/google-drive-logo_j5udd7.webp"
                    alt="Google Drive"
                />
                <img
                    height="75px"
                    width="150px"
                    class="h-12 w-auto object-contain opacity-50 transition duration-250 ease-in-out transform hover:scale-110 hover:opacity-100"
                    src="https://res.cloudinary.com/cumulus-creative-services/image/upload/h_75/v1609135539/Cumulus%20Website/logo-color-transparent_qv2oyl.svg"
                    alt="Click Up"
                />
                <img
                    height="75px"
                ...
                <img
                    ...
                    width="150px"
                    class="h-12 w-auto object-contain opacity-50 transition duration-250 ease-in-out transform hover:scale-110 hover:opacity-100"
                    src="https://res.cloudinary.com/cumulus-creative-services/image/upload/h_75/v1609136299/Cumulus%20Website/83809024-9da80580-a66a-11ea-8a1d-090fe6f8b01e_zrrpzr.webp"
                    alt="Capacitor"
                />
                <img
                    height="75px"
                    width="150px"
                    class="h-12 w-auto object-contain opacity-50 transition duration-250 ease-in-out transform hover:scale-110 hover:opacity-100"
                    src="https://res.cloudinary.com/cumulus-creative-services/image/upload/h_75/v1609136356/Cumulus%20Website/logo-text-red_p2bafv.webp"
                    alt="Framework7"
                />
                <img
                    height="75px"
                    width="150px"
                    class="h-12 w-auto object-contain opacity-50 transition duration-250 ease-in-out transform hover:scale-110 hover:opacity-100"
                    src="https://res.cloudinary.com/cumulus-creative-services/image/upload/h_75/v1609136432/Cumulus%20Website/zapier-logo_f92g1z.webp"
                    alt="Zapier"
                />
                <img
                    height="75px"
                    width="150px"
                    class="h-12 w-auto object-contain opacity-50 transition duration-250 ease-in-out transform hover:scale-110 hover:opacity-100"
                    src="https://res.cloudinary.com/cumulus-creative-services/image/upload/h_75/v1609136999/Cumulus%20Website/integromat-white_pe9las.svg"
                    alt="Integromat"
                />
                <img
                    height="75px"
